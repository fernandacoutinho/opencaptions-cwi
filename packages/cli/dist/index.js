...
import { TerminalRenderer, exportAfterEffectsScript, exportPremiereXML, exportWebVTT, } from "@opencaptions/renderer";
...
async function cmdValidate(args) {
    ...
    try {
        const doc = JSON.parse(readFileSync(resolve(filePath), "utf-8"));
