...
export type Emotion = "joy" | "sadness" | "anger" | "fear" | "surprise" | "disgust" | "contempt" | "neutral" | "uncertain";
/**
...
export type IntentMapper = (word: DiarizedWord, frame: IntentFrame, speaker: Speaker, override?: WordIntent) => Pick<CWIWord, "weight" | "size" | "emphasis">;
/** Validation rule identifiers organized by CWI pillar. */
export type RuleId = "ATT_001" | "ATT_002" | "ATT_003" | "SYN_001" | "SYN_002" | "SYN_003" | "SYN_004" | "INT_001" | "INT_002" | "INT_003" | "FCC_001" | "FCC_002";
...
export declare const CWI_DEFAULTS: {
    readonly ANIMATION_DURATION_MS: 600;
    readonly ANIMATION_DELAY_MS: 100;
    readonly ANIMATION_EASING: "ease";
    readonly EMPHASIS_BOUNCE_PERCENT: 15;
    readonly FONT_FAMILY: "Roboto Flex";
    readonly WEIGHT_MIN: 100;
    readonly WEIGHT_MAX: 900;
    readonly SIZE_MIN: 0.7;
    readonly SIZE_MAX: 1.5;
    readonly MAX_CHARS_PER_LINE: 42;
    readonly MAX_SPEECH_GAP_SECONDS: 3;
    readonly PILLAR_PASS_THRESHOLD: 80;
    readonly INTONATION_MIN_VARIED_PERCENT: 20;
};
/**
 ...
 */
export declare const SPEAKER_COLORS: readonly ["#6B8AFF", "#FF6B6B", "#6BFFA3", "#FFD56B", "#D56BFF", "#6BF0FF", "#FF6BC8", "#A3FF6B", "#FF916B", "#6BB4FF", "#FFB86B", "#8A6BFF"];
/** JSON Schema URI for CWI documents. */
export declare const CWI_SCHEMA_URI = "https://opencaptions.tools/schema/cwi/1.0.json";
/** Current CWI document version. */
export declare const CWI_VERSION: "1.0";
